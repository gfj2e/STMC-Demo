...
urlpatterns = [
    ...
    path("manager/pdf/<int:job_id>/<str:kind>/print/", views.manager_pdf_print_view, name="manager_pdf_print"),
    path("manager/pdf/picker-modal/", views.manager_pdf_picker_modal_view, name="manager_pdf_picker_modal"),
