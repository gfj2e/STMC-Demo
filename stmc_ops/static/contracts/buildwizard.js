  ...
  BACKEND.jobs.list()
    .then(function(jobs){
      ...
      jobs.forEach(function(j){
        ...
        h += '<button class="footer-btn" onclick="cloudLoadJobById(\'' + esc(j.id) + '\')">Load</button>';
        h += '</div>';
      });
      listEl.innerHTML = h;
    })
